...
const data = new SlashCommandBuilder()
  .setName('puzzle')
  .setDescription('Add new puzzle tab to the solving spreadsheet of this channel.')
  ...
  .addStringOption(option =>
    option.setName('title')
      .setDescription('The title of the puzzle. Default is the title of the given url.'))
